...
function ProfileScreen({ dark, onToggleDark }) {
  return (
    <Body>
      ...
      <button style={{ border: '1px solid color-mix(in srgb, var(--danger) 30%, transparent)', cursor: 'pointer',
...
Object.assign(window, { Header, TabBar, HomeScreen, PointageScreen: React.memo(PointageScreen),
